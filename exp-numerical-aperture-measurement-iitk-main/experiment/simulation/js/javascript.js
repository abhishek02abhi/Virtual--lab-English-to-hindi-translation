...
window.onload = function () {
                ...
                case operationType.DRAW_FIBRE_CABLE:
                    if (elementCount.cable < 1) {
                        if (elementCount.stand > 0) {
                            ...
                            terminal.update("फाइबर स्टैंड नहीं मिला।");
                        }
                    }
                    break;
    ...
    simulator.rangeButton.addEventListener("input", function (e) {
        ...
        terminal.update("व्यास (D) = " + (2 * r) + "mm");
        simulator.draw();
    }, false);
...
function createTable() {
    var str = "<h3 class='text-center'>डेटा तालिका</h3>";
    str += "<table>";
    str += "<tr><th>क्रम संख्या</th><th>स्क्रीन की दूरी (L) में mm</th><th>व्यास (D) में mm</th></tr>";
...
function drawGraph() {
    ...
    for (let i = 1; i <= 4; i++) {
        ...
        graphline("l1", datapoints1, "व्यास (D) में mm", "दूरी  (L) में mm");
    }
}
...
function varify(e) {
    ...
    if(answer=="" || isNaN(answer)){
        alert("बॉक्स खाली है या गलत मान दर्ज किया गया है।");
        terminal.update("बॉक्स खाली है या गलत मान दर्ज किया गया है।");
        return;
    }
    var perError = (simulator.cable.NA - answer) / simulator.cable.NA;
    perError = perError.toFixed(2);
    terminal.update("प्रतिशत त्रुटि = " + (perError *100) +"%");
    alert("प्रतिशत त्रुटि = " + (perError *100) +"%");
}